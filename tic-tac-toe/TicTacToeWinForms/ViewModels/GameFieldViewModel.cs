...
namespace TicTacToeWinForms.ViewModels
{
    ...
    public class GameFieldViewModel : ReactiveObject
    {
        ...
        /// </summary>
        private ObservableCollection<CellViewModel> _cellsList;
        ...
        public GameFieldViewModel(IGame game, IMessageBoxService messageBoxService)
        {
            ...
            _cellsList = new ObservableCollection<CellViewModel>();
            ...
            this.WhenAnyValue(vm => vm._cellsList)
                .SelectMany(cells => cells)
                .Select(cell => cell.WhenAnyValue(x => x.IsEmpty).Select(_ => cell))
                .Merge()
                .Subscribe(x => 
            {
