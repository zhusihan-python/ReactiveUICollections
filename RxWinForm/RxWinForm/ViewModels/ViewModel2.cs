...
namespace RxWinForm.ViewModels
{
    public class ViewModel2 : ReactiveObject
    {
        ...
        public ReactiveCommand<Unit, Unit> CmdLogin { get; private set; }
        public ReactiveCommand<Unit, Unit> CmdProcessLoginAsync { get; protected set; }
        public ReactiveCommand<Unit, Unit> CmdCancel { get; protected set; }
            ...
            IObservable<int> progress)
        {
            ...
            CmdLogin = ReactiveCommand.Create<Unit, Unit>(
                _ => Unit.Default,
                CanUserLogin
            );
